...
(function () {
  ...
  const COPY = {
    ...
    ja: {
      ...
      r5: "日次・フロアプール・招待には入らない。チケットではない。",
    ...
    vi: {
      ...
      r5: "Không vào quỹ ngày, quỹ nền, hay mời. Không phải vé.",
    ...
    th: {
      ...
      r5: "ไม่เข้ากองวัน กองฐาน หรือชวน ไม่ใช่ตั๋ว",
    ...
    ru: {
      ...
      r5: "Не дневной пул, не база и не инвайт. Не билет.",
    ...
    id: {
      ...
      r5: "Bukan pool harian, pool dasar, atau undangan. Bukan tiket.",
    ...
    fil: {
      ...
      r5: "Hindi daily pool, floor, o invite. Hindi ticket.",
